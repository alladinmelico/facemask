<template>
	<div>
		...
		<inertia-link
			:href="href"
			class="block px-4 py-2 text-sm leading-5 text-gray-700 hover:bg-light-primary focus:outline-none focus:bg-light-primary transition duration-150 ease-in-out"
			v-else
		>
			<slot></slot>
		</inertia-link>
